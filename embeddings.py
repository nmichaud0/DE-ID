...
def get_embeddings(strings: list[str], layer: int = -1, model_type: str = 'hf') -> torch.tensor:

    assert model_type in ('hf', 'sbert'), f'model_type must be "hf" or "sbert", got {model_type}'
...
if __name__ == '__main__':
    x = get_embeddings(['Hi', 'this', 'is', 'a', 'test'], model_type='sbert')