...
from gpt_oss_checkpoint import Checkpoint


print('checkpoint 11h16')
...
class AttentionBlock(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        q, k, v, sinks = q.to('cuda'), k.to('cuda'), v.to('cuda'), self.sinks.to('cuda')

        t = sdpa(q, k, v, sinks, self.sm_scale, self.sliding_window).to(self.device)
